<?php 
if ( ! class_exists( 'Atozsites_Admin_Page_Class') ) :

  class Atozsites_Admin_Page_Class {
    ...
    public function DisplayPage() {
      ...
      wp_nonce_field( basename(__FILE__), 'Atozsites_Admin_Page_Class_nonce' );
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
  ...
  public function save($repeater = false) {
    ...
    //check nonce
    if ( ! check_admin_referer( basename( __FILE__ ), 'Atozsites_Admin_Page_Class_nonce') )
      return;
    ...
    foreach ( $this->_fields as $field ) {
      if(!in_array($field['type'],$skip)){
        ...
        //issue #27
        $validationClass = apply_filters('apc_validattion_class_name', 'Atozsites_Admin_Page_Class_Validate',$this);
  ...
  public function get_font_style(){
    ...
    return apply_filters( 'Atozsites_available_fonts_style', $default );
  }
  ...
  public function get_font_weight(){
    ...
    return apply_filters( 'Atozsites_available_fonts_weights', $default );
  }
