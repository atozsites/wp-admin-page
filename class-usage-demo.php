<?php
/*
Plugin Name: Atozsites Admin Page
Plugin URI: http://atozsites.com
Description: Atozsites WP Admin Page
Version: 1.0
Author: Atozsites
Author URI: https://github.com/atozsites/wp-admin-page
*/
   ...
   */
  $options_panel = new Atozsites_Admin_Page_Class($config);
